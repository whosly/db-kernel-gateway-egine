...
| [CONSOLE_ARCHITECTURE.md](CONSOLE_ARCHITECTURE.md) | **管控台前后端架构（分层 / 契约 v1 / Vue+TS+Vite / Phase A–B）** | §11 A+ · §12 Phase B；自检通过 |
...
5. SQL Server：[`SQLSERVER_TDS_PLAN.md`](SQLSERVER_TDS_PLAN.md) → 代码 `adapter/sqlserver`。
