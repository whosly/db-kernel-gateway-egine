...
| 项 | 现状 | 证据 |
|---|---|---|
| 非集成 `@Test`/`@ParameterizedTest` 注解数 | **514** | `mvn test` Results；排除 `*IntegrationTest` |
